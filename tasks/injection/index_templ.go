...
func LoginSuccess(username string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"mt-10 flex items-center justify-center bg-gray-100\"><div class=\"max-w-md w-full space-y-8 p-10 bg-white rounded-lg shadow-md\"><div><h2 class=\"mt-6 text-center text-3xl font-extrabold text-gray-900\">Welcome, ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
