...
func updateShoppingCart() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_updateShoppingCart_8486`,
		Function: `function __templ_updateShoppingCart_8486(){// update the shopping cart sum
   
    return cartValue;
}`,
		Call:       templ.SafeScript(`__templ_updateShoppingCart_8486`),
		CallInline: templ.SafeScriptInline(`__templ_updateShoppingCart_8486`),
	}
}
...
func Product(product ProductData) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `tasks\validation\index.templ`, Line: 86, Col: 69}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `tasks\validation\index.templ`, Line: 88, Col: 78}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `tasks\validation\index.templ`, Line: 89, Col: 58}
		}
...
func BuyButtonClick() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_BuyButtonClick_2f30`,
		Function: `function __templ_BuyButtonClick_2f30(){document.getElementById("buy-button").addEventListener('click', function() {
		...
		Call:       templ.SafeScript(`__templ_BuyButtonClick_2f30`),
		CallInline: templ.SafeScriptInline(`__templ_BuyButtonClick_2f30`),
	}
}
